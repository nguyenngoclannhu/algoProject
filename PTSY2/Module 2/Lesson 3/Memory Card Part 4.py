...
policy = score_numb.sizePolicy()
policy.setHorizontalPolicy(QSizePolicy.Expanding)
score_numb.setSizePolicy(policy)
score_layout.addWidget(score_lb, stretch = 0)
score_layout.addWidget(score_numb)
 
layout_card = QVBoxLayout()
layout_card.addLayout(score_layout, stretch = 1)
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        score_numb.setText(str((window.score/(window.total*100)))+"%")
    else:
